...
CREATE TABLE `guarderias` (
  `idGuarderia` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `guarderias` VALUES (1,'Guardería Canina Buen Amigo','Calle Perros 101, Ciudad Perro',5554321),(2,'Peludos en Guardia','Av. Mascotas 200, Barrio Peludo',5558765),(3,'Guardería Patitas Felices','Calle Ladridos 150, Perrolandia',5551122),(4,'La favorita','Paseo de los Perros 333, Zona Canina',5552233),(5,'Aventuras Peludas','Calle Huellas 50, Canilandia',5554455);
